...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Kripto</b>Grapi</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url(); ?>dist/img/mira.jpg.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">MIRA</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url(); ?>dist/img/mira.jpg.jpg" class="img-circle" alt="User Image">
...
$en = $cipher->decrypt($_POST['enk'], $_POST['key']);
...
echo "<h1>$en<br></h1>";
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright MIRA.</strong> All rights
    reserved.
  </footer>
